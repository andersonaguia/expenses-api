...
export class Expense1682781738896 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`expense\` ADD CONSTRAINT \`FK_94c81dfc4d780f85a4f529dfe26\` FOREIGN KEY (\`modifiedById\`) REFERENCES \`system_users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`expense\` DROP FOREIGN KEY \`FK_94c81dfc4d780f85a4f529dfe26\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX \`IDX_259a2bbc375e2fb8a50683a95a\` ON \`expense\``,
    );
    await queryRunner.query(
      `DROP INDEX \`IDX_4376292a4cd9cb1d3bbe56523a\` ON \`expense\``,
    );
